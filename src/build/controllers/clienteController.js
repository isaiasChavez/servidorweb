...
class ClienteController {
    ...
    actualizar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query("UPDATE Cliente set ? WHERE email_Cliente = ?", [req.body, codigo]);
            res.json(resp);
        });
    }
    eliminar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query(`DELETE FROM Cliente WHERE email_Cliente= ${emailCliente}`);
            res.json(resp);
        });
    }
}
